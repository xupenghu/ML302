...
static int MQTTstrlen(MQTTString mqttstring);
...
static int MQTTSerialize_ack(unsigned char *buf, int buflen, unsigned char type, unsigned char dup, unsigned short packetid);
static int MQTTDeserialize_ack(unsigned char *packettype, unsigned char *dup, unsigned short *packetid, unsigned char *buf,
                        int buflen);

static int MQTTPacket_len(int rem_len);
static int MQTTPacket_equals(MQTTString *a, char *b);

static int MQTTPacket_encode(unsigned char *buf, int length);
static int MQTTPacket_decode(int (*getcharfn)(unsigned char *, int), int *value);
static int MQTTPacket_decodeBuf(unsigned char *buf, int *value);
...
static int readMQTTLenString(MQTTString *mqttstring, unsigned char **pptr, unsigned char *enddata);
static void writeCString(unsigned char **pptr, const char *string);
static void writeMQTTString(unsigned char **pptr, MQTTString mqttstring);
